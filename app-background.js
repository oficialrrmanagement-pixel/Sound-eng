...
addEventListener('load',()=>{applyTeamDuckBackground();loadStyle('premium-ui.css?v=20260819-premium1','premium-ui');loadScript('dual-assignments.js?v=20260819-split2','dual-assignments',()=>{setTimeout(()=>window.TeamDuckAssignments?.refresh?.(),50)});loadScript('finance-summary.js?v=20260819-split1','finance-summary',()=>{setTimeout(()=>window.TeamDuckFinance?.refresh?.(),50)});loadScript('role-layout.js?v=20260819-role-preview2','role-layout',()=>{setTimeout(()=>window.TeamDuckRoleLayout?.apply?.(),80)})});
})();